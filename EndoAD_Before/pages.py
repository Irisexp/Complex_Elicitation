...
class WaitforP1(WaitPage):
    def after_all_players_arrive(self):
        ...
        print ('attribute first')
        print(self.group.attribute_first)
        print ('attribute second')
        print(self.group.attribute_second)
        print ('attribute third')
        print(self.group.attribute_third)
        print ('report first')
        print(self.group.report_first)
        print ('report second')
        print(self.group.report_second)
        print ('report third')
        print(self.group.report_third)
        print ('check first')
        print(self.group.check_first)
        print ('check second')
        print(self.group.check_second)
        print ('check third')
        print(self.group.check_third)
