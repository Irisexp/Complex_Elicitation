...
page_sequence = [init_calc, Overview, Instructions_first, Instructions_second, Observation, WaitforP2, Sender_report, WaitforP1, Receiver_guess, Waitforall, Results]
